...
## Goal
A playable **web build** of Mario Kart 64, built from the community decomp, where **every asset the decomp extracts from the ROM is regenerated** (clean room), published as `andrewnakas/mk64-cleanroom` + GitHub Pages. Same result as Super Mario 64 (https://andrewnakas.github.io/sm64-cleanroom/) and Pilotwings 64.
...
- Work dirs: `C:/Users/andre/n64work/mk64/` (pristine, dirty, clean, build). **E: is nearly full**: build on C:. emsdk: `E:/n64web/emsdk` (EM_CACHE=E:/n64web/emcache).
...
- Decomp: https://github.com/n64decomp/mk64
